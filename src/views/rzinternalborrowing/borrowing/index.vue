<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="借款方" prop="borrower">
        <el-select v-model="queryParams.borrower" placeholder="请选择借款方" clearable>
          <el-option
            v-for="dict in dict.type.sys_1759501577938272300"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="收款方" prop="payee">
        <el-select v-model="queryParams.payee" placeholder="请选择收款方" clearable>
          <el-option
            v-for="dict in dict.type.sys_1759501640206909400"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="还款方式：先息后本" prop="repaymentMethod">
        <el-select v-model="queryParams.repaymentMethod" placeholder="请选择还款方式：先息后本" clearable>
          <el-option
            v-for="dict in dict.type.sys_1759501742422098000"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
      ...
      <el-form-item label="借款用途：保交楼、城中村改造" prop="loanUse">
        <el-select v-model="queryParams.loanUse" placeholder="请选择借款用途：保交楼、城中村改造" clearable>
          <el-option
            v-for="dict in dict.type.sys_1759501814702538800"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['rzinternalborrowing:borrowing:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['rzinternalborrowing:borrowing:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['rzinternalborrowing:borrowing:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['rzinternalborrowing:borrowing:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="borrowingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="内部借款管理编号" align="center" prop="managementId" />
