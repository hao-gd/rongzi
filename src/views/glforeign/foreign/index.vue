<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="foreignList" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="担保金额（万元）" align="center" prop="guaranteeAmount">
        <template slot-scope="scope">
          <span>{{ formatNumberAsRMB(scope.row.guaranteeAmount) }}</span>
        </template>
      </el-table-column>
      <el-table-column label="担保余额（万元）" align="center" prop="guaranteeBalance">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否上征信" align="center" prop="isCreditInvestigation">
        <template slot-scope="scope">
